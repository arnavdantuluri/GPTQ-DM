...
print('Quantizing...')
tick = time.time()
quantizers = sdxl_sequential(attn, dataloader, None, None, None, None, None, None, None, "cuda", wbits=wbits, nsamples=nsamples, true_sequential=true_sequential, sym=sym, percdamp=percdamp, groupsize=groupsize, act_order=act_order)
print(f"Total time: {time.time() - tick:.2f}s")

print('Packing...')
sdxl_pack(attn, quantizers, wbits, groupsize)
